exports = module.exports = function(decode, services, Utilization, translate, Tokens, rsg) {
      ...
      decode(info, function(err, info) {
        ...
        services.get(info.permissions[0].resourceID, function(err, resource) {
          ...
          translate(ctx, function(err, claims) {
            ...
            var sparms = Utilization.negotiate(client.authenticationSchemes, resource.authenticationSchemes)
...
exports['@require'] = [
  ...
  'http://i.bixbyjs.org/tokens/jwt/translate',
