...
StateStore.prototype.store = function(req, txn, cb) {
  var self = this;
...
StateStore.prototype.update = function(req, h, txn, cb) {
  var self = this;
  this._serializeClientFunc(txn.client, function(err, client) {
    if (err) { return cb(err); }
...
// FIXME: Implement remove, why is it not happening and/or erroring?
